...
| `software-development/shared-api-contract-sync` | `shared-api-contract-sync` | Design, update, and verify shared API contract packages that synchronize backend APIs with frontend web/app consumers. |
